# Gambia — World Airports Database

1 records for **Gambia** (GM).
...
| **Excel / CSV / PDF** (Gambia only) | [listbase.org](https://listbase.org/en/transport/) |
...
```sql
SELECT * FROM airports WHERE country = 'GM';
```
...
📊 **[Download Gambia data as Excel/CSV/PDF](https://listbase.org/en/transport/)**
