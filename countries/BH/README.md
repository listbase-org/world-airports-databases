# Bahrain — World Airports Database

1 records for **Bahrain** (BH).
...
| **Excel / CSV / PDF** (Bahrain only) | [listbase.org](https://listbase.org/en/transport/) |
...
```sql
SELECT * FROM airports WHERE country = 'BH';
```
...
📊 **[Download Bahrain data as Excel/CSV/PDF](https://listbase.org/en/transport/)**
