...
| **Excel / CSV / PDF** (KS only) | [listbase.org](https://listbase.org/en/transport/) |
...
```sql
SELECT * FROM airports WHERE country = 'KS';
```
...
📊 **[Download KS data as Excel/CSV/PDF](https://listbase.org/en/transport/)**
