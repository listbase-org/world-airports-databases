# Malta — World Airports Database

1 records for **Malta** (MT).
...
| **Excel / CSV / PDF** (Malta only) | [listbase.org](https://listbase.org/en/transport/) |
...
```sql
SELECT * FROM airports WHERE country = 'MT';
```
...
📊 **[Download Malta data as Excel/CSV/PDF](https://listbase.org/en/transport/)**
